...
/// creating a module for all the message related shits
mod msg{
    // pub keyword is used to make them all public
...
fn main() {
    ...
    let result = {
        // we use math::fun_name to run function in math module
    ...
    // we create a scope to use all the msg functions
    {
        use msg::*;
        let hello = {
            let msg = "hello ";
