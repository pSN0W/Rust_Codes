...
impl PowerState {
    fn new(state: &str) -> Option<PowerState> {
        ...
        // .as_str() converts owned string to string slice
        match state.as_str() {
...
fn print_power_action(state: PowerState) {
    // this let's us use type of PowerState enum without writing PowerState explicitily
    // PowerState::Off --> Off
    use PowerState::*;
    match state {
...
fn main() {
    ...
    // .is_ok() ensures that there were no problem with taking input
